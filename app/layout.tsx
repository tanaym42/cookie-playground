...
export default function RootLayout({
  ...
  return (
    ...
    <head>
      ...
      <meta http-equiv="Content-Security-Policy" content="default-src 'self' data: gap: https://ssl.gstatic.com 'unsafe-eval' https://cdn.cookielaw.org; style-src 'self' 'unsafe-inline'; media-src *; script-src 'self' https://cdn.cookielaw.org http://onlineerp.solution.quebec https://www.googletagmanager.com 'unsafe-inline' 'unsafe-eval';"/>
